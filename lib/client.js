...
Client.prototype._attachApi = function () {
  ...
  return new Promise(function(resolve, reject) {
    ...
    // Add a timeout so DNS resolution failures (ENOTFOUND) or unreachable
    // hosts fail quickly during tests instead of hanging indefinitely.
    request({ url: ariUrl, timeout: 1000 }, function (err) {
      if (err &&
